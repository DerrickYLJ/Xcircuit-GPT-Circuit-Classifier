...
print("[INFO] loading the Training Image dataset...")
...
trainData = custom_data.CustomImageDataset(annotations_file, img_dir, image_size=(256, 256))
train_dataloader = DataLoader(training_data, batch_size=32, shuffle=True)
testData = custom_data.CustomImageDataset(annotations_file, img_dir, image_size=(256, 256))
test_dataloader = DataLoader(training_data, batch_size=32, shuffle=True)
